...
function Signin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('There is some error from server.')
        }
    }
        ...
        <>
            <div className="container">
                <div className="signin">SIGN-IN
                    ...
                    <div id="orsignup">Or</div>
                    <button id="signuplink"><Link to="/" style={{color:'aliceblue', textDecoration:'none'}}>Signup</Link></button>
                </div>
            </div>
        </>
    )
